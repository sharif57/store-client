...
const Register = () => {
    ...
    const handleRegister = (e) => {
        ...
        if (/^(?=.*[A-Z])(?=.*[a-z]).{6,}$/.test(password)) {
            ...
            setError('Password must be at least 6 characters long and include both upper and lower case letters.');
        }
    };
        ...
        <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
            <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                ...
                <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div className="max-w-md mx-auto">
                        ...
                        <form onSubmit={handleRegister} className="divide-y divide-gray-200">
                            <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <div className="relative">
                                    <button className="bg-cyan-500 text-white rounded-md w-full px-2 py-1">
                                        Register
                                    </button>
                                </div>
                    ...
                    <div className="mt-4">
                        <p>Already have an account? <Link to={'/login'} className="font-bold border-b-2 border-emerald-500">Login</Link></p>
                    </div>
                </div>
            </div>
        </div>
