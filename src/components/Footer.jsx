    ...
    return <div>
        <footer className="px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3 flex gap-2 items-center justify-start">
                <GrTechnology className="size-20" /> <span className="text-error font-bold font-serif text-3xl">Tech</span>
                </div>
